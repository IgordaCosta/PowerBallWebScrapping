...
const sqliteInputTable = require(path.resolve(__dirname, './sqliteInputTable'))
...
GetDataFromSite(NewDatabase)

//exports.GetDataFromSite = function (DataBaseType){
function GetDataFromSite(DataBaseType){


yearList=DataBaseType[0]
DatabaseName=DataBaseType[1]
//amount of columns,
...
function GetColumnValue(){
  ...
  if (yearIndex+1==yearList.length){
    ...
    sqliteInputTable.passToSqlite(JoinedArray,DatabaseName);
